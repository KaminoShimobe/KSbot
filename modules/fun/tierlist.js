...
module.exports = {
   ...
   async execute(interaction) {
    ...
    for(i = 0; i < aTiers.length; i++){
        let user = interaction.client.guild.members.search("username", aTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
    ...
    for(i = 0; i < bTiers.length; i++){
        let user = interaction.client.guild.members.search("username", bTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
    ...
    for(i = 0; i < cTiers.length; i++){
        let user = interaction.client.guild.members.search("username", cTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
    ...
    for(i = 0; i < dTiers.length; i++){
        let user = interaction.client.guild.members.search("username", dTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
    ...
    for(i = 0; i < eTiers.length; i++){
        let user = interaction.client.guild.members.search("username", eTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
    ...
    for(i = 0; i < fTiers.length; i++){
        let user = interaction.client.guild.members.search("username", fTiers[i]);
        if(i < 9){
            if(user != undefined){
                const { body } = await request(user.displayAvatarURL({ format: 'jpg' }));
                const avatar = new Image();
